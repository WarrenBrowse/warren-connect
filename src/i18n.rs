...
const FR: Strings = Strings {
    ...
    a_code_body: "Saisissez le code \u{e0} 6 chiffres affich\u{e9} par votre application Warren pour terminer la connexion dans ce navigateur. Ne donnez jamais ce code \u{e0} personne, m\u{ea}me \u{e0} quelqu'un qui se pr\u{e9}sente comme venant de Warren.",
...
const RO: Strings = Strings {
    ...
    a_code_body: "Introdu codul de 6 cifre afi\u{219}at de aplica\u{21b}ia Warren pentru a finaliza autentificarea \u{ee}n acest browser. Nu da niciodat\u{103} acest cod nim\u{103}nui, nici cuiva care spune c\u{103} este de la Warren.",
