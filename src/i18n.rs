...
pub(crate) struct Strings {
    ...
    /// Shown when the deep-link tap did not take the browser to the app
    /// (measured by the page never losing visibility): the one moment the
    /// user needs to be told what to do instead of watching a spinner.
    pub(crate) a_noapp_heading: &'static str,
    pub(crate) a_noapp_browser: &'static str,
    pub(crate) a_noapp_code: &'static str,
    pub(crate) a_noapp_install: &'static str,
    pub(crate) a_copy: &'static str,
    pub(crate) a_copied: &'static str,
    /// The confirm step: the app approved, and this browser proves it is the
    /// one the app approved by typing the code the app shows. `a_code_wrong`
    /// carries `{n}`, replaced by the attempts left.
    pub(crate) a_awaiting: &'static str,
    pub(crate) a_code_heading: &'static str,
    pub(crate) a_code_body: &'static str,
    pub(crate) a_code_label: &'static str,
    pub(crate) a_code_button: &'static str,
    pub(crate) a_code_wrong: &'static str,
    pub(crate) a_code_shape: &'static str,
    pub(crate) a_code_retry: &'static str,
    ...
    /// The handoff page the app opens in its own browser after a same-device
    /// approval. The mismatch copy is the relay victim's warning.
    pub(crate) h_heading: &'static str,
    pub(crate) h_working: &'static str,
...
const EN: Strings = Strings {
    ...
    a_copy: "Copy code",
    a_copied: "Copied",
    a_awaiting: "Your Warren app approved this sign-in.",
    a_code_heading: "Enter the code from your Warren app",
    a_code_body: "Type the 6-digit code your Warren app shows to finish signing in on this browser. Never give this code to anyone, including someone who says they are from Warren.",
    a_code_label: "6-digit code",
    a_code_button: "Finish signing in",
    a_code_wrong: "Wrong code. Attempts left: {n}",
    a_code_shape: "The code is 6 digits.",
    a_code_retry: "The code could not be sent. Check your connection and try again.",
    ...
    h_working: "Finishing the sign-in in this browser\u{2026}",
...
const FR: Strings = Strings {
    ...
    a_copied: "Copi\u{e9}",
    a_awaiting: "Votre application Warren a approuv\u{e9} cette connexion.",
    a_code_heading: "Saisissez le code de votre application Warren",
    a_code_body: "Saisissez le code \u{e0} 6 chiffres affich\u{e9} par votre application Warren pour terminer la connexion dans ce navigateur. Ne donnez jamais ce code \u{e0} personne, m\u{ea}me \u{e0} quelqu'un qui pr\u{e9}tend travailler pour Warren.",
    a_code_label: "Code \u{e0} 6 chiffres",
    a_code_button: "Terminer la connexion",
    a_code_wrong: "Code incorrect. Essais restants : {n}",
    a_code_shape: "Le code comporte 6 chiffres.",
    a_code_retry: "Le code n'a pas pu \u{ea}tre envoy\u{e9}. V\u{e9}rifiez votre connexion et r\u{e9}essayez.",
    ...
    a_mismatch: "Cette page ne correspond plus \u{e0} aucune connexion en cours : elle a expir\u{e9}, ou ce navigateur bloque les cookies. Fermez cette page et reconnectez-vous depuis le forum.",
    ...
    e_heading: "Cette connexion a \u{e9}t\u{e9} lanc\u{e9}e depuis un autre navigateur",
    e_body: "Le lien de connexion que vous avez ouvert est d\u{e9}j\u{e0} utilis\u{e9} par un autre navigateur : la connexion ne peut pas se poursuivre ici. Revenez au forum et cliquez \u{e0} nouveau sur Se connecter.",
    h_heading: "Finalisation de votre connexion",
    h_working: "Finalisation de la connexion dans ce navigateur\u{2026}",
    h_mismatch_heading: "Cette connexion n'a pas \u{e9}t\u{e9} lanc\u{e9}e depuis ce navigateur",
    h_mismatch_body: "La connexion que votre application Warren vient d'approuver a \u{e9}t\u{e9} lanc\u{e9}e depuis un autre navigateur, ou elle a expir\u{e9}. Si vous l'avez lanc\u{e9}e vous-m\u{ea}me depuis un autre navigateur, revenez-y et saisissez le code affich\u{e9} par votre application Warren. Si quelqu'un vous a envoy\u{e9} un lien ou un code \u{e0} approuver, cette personne essayait de se connecter au forum \u{e0} votre place : ne lui envoyez rien.",
...
const RO: Strings = Strings {
    ...
    a_copied: "Copiat",
    a_awaiting: "Aplica\u{21b}ia Warren a aprobat aceast\u{103} autentificare.",
    a_code_heading: "Introdu codul din aplica\u{21b}ia Warren",
    a_code_body: "Introdu codul de 6 cifre afi\u{219}at de aplica\u{21b}ia Warren pentru a finaliza autentificarea \u{ee}n acest browser. Nu da niciodat\u{103} acest cod nim\u{103}nui, nici m\u{103}car cuiva care spune c\u{103} este de la Warren.",
    a_code_label: "Cod de 6 cifre",
    a_code_button: "Finalizeaz\u{103} autentificarea",
    a_code_wrong: "Cod gre\u{219}it. \u{ce}ncerc\u{103}ri r\u{103}mase: {n}",
    a_code_shape: "Codul are 6 cifre.",
    a_code_retry: "Codul nu a putut fi trimis. Verific\u{103}-\u{21b}i conexiunea \u{219}i \u{ee}ncearc\u{103} din nou.",
    ...
    a_exhausted: "Prea multe coduri gre\u{219}ite: aceast\u{103} autentificare a fost anulat\u{103}. Dac\u{103} nu ai pornit-o tu, este posibil ca cineva s\u{103} fi \u{ee}ncercat s\u{103} se autentifice \u{ee}n numele t\u{103}u. Ca s\u{103} te autentifici, \u{ee}ncepe din nou de pe forum.",
    ...
    h_working: "Se finalizeaz\u{103} autentificarea \u{ee}n acest browser\u{2026}",
    h_mismatch_heading: "Acest browser nu a pornit aceast\u{103} autentificare",
    h_mismatch_body: "Autentificarea pe care aplica\u{21b}ia Warren tocmai a aprobat-o a fost pornit\u{103} \u{ee}n alt browser sau a expirat. Dac\u{103} ai pornit-o chiar tu \u{ee}n alt browser, revino acolo \u{219}i introdu codul afi\u{219}at de aplica\u{21b}ia Warren. Dac\u{103} cineva \u{21b}i-a trimis un link sau un cod de aprobat, acea persoan\u{103} \u{ee}ncerca s\u{103} se autentifice pe forum d\u{e2}ndu-se drept tine: nu-i trimite nimic.",
